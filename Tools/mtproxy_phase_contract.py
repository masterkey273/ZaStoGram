...
PHASES = (
    ...
    MtProxyPhase("secret_parse_invalid_domain_control_char", PHASE_FAILURE, native=True, java=True, analyzer=True, endpoint_key=ENDPOINT_EXACT),
    MtProxyPhase("secret_parse_invalid_domain", PHASE_FAILURE, native=True, java=True, analyzer=True, endpoint_key=ENDPOINT_EXACT),
    MtProxyPhase("client_hello_sent_no_server_hello", PHASE_FAILURE, native=True, java=True, analyzer=True, endpoint_key=ENDPOINT_EXACT),
